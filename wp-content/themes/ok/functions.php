...
function bones_register_sidebars() {
  ...
  register_sidebar(array(
		'id' => 'sidebar_interior',
		'name' => __( 'Sidebar Interiores', 'bonestheme' ),
		'description' => __( 'Sidebar de interiores.', 'bonestheme' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
...
function bones_fonts() {
  ...
  wp_register_style('googleFonts', 'http://fonts.googleapis.com/css?family=Oswald:400,300,700|Dosis:500,400,700|Roboto+Slab:400,700');
...
function texto_intro($length) {
global $post;
$text = get_the_excerpt($post->ID);
if (strlen($text) > $length) {
$text = substr($text,0,strpos($text,' ',$length)) . ' ... <a href="' . get_permalink() . '">[ leér más ]</a>'; } ;
